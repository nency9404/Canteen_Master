...
export const GET_MENU_ITEMS_BY_CANTEEN_ID_REQUEST = "GET_MENU_ITEMS_BY_CANTEEN_ID_REQUEST";
export const GET_MENU_ITEMS_BY_CANTEEN_ID_SUCCESS = "GET_MENU_ITEMS_BY_CANTEEN_ID_SUCCESS";
export const GET_MENU_ITEMS_BY_CANTEEN_ID_FAILURE = "GET_MENU_ITEMS_BY_CANTEEN_ID_FAILURE";
...
export const UPDATE_MENU_ITEMS_AVAILABLITY_REQUEST = "UPDATE_MENU_ITEMS_AVAILABLITY_REQUEST";
export const UPDATE_MENU_ITEMS_AVAILABLITY_SUCCESS = "UPDATE_MENU_ITEMS_AVAILABLITY_SUCCESS";
export const UPDATE_MENU_ITEMS_AVAILABLITY_FAILURE = "UPDATE_MENU_ITEMS_AVAILABLITY_FAILURE";
